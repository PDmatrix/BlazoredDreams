...
export const UsersApiAxiosParamCreator = function(configuration?: Configuration) {
  return {
    ...
    usersChangeImage(
      ...
      const localVarPath = `/api/Users/image`;
      const localVarUrlObj = url.parse(localVarPath, true);
      let baseOptions;
      if (configuration) {
        baseOptions = configuration.baseOptions;
...
export const UsersApiFp = function(configuration?: Configuration) {
  return {
    ...
    usersChangeImage(
      ...
      const localVarAxiosArgs = UsersApiAxiosParamCreator(configuration).usersChangeImage(
        contentType,
        contentDisposition,
        headers,
        length,
...
export const UsersApiFactory = function(
  ...
  return {
    ...
    usersChangeImage(
      ...
      return UsersApiFp(configuration).usersChangeImage(
        contentType,
        contentDisposition,
        headers,
        length,
...
export class UsersApi extends BaseAPI {
  ...
  public usersChangeImage(
    ...
    return UsersApiFp(this.configuration).usersChangeImage(
      contentType,
      contentDisposition,
      headers,
      length,
